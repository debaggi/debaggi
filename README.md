...
▶ Продуктовый кейс: анализ поведения пользователей платформы для изучения иностранного языка Babbel<br>
 [Перейти к проекту Babbel](https://github.com/debaggi/debaggi-cases/tree/main/Babbel%20case)<br>

▶ Проектировочный кейс: разработка интерактивной панели загруженности менеджеров в течение рабочего дня сервиса аренды домов HouseGet<br>
[Перейти к проекту HouseGet](https://github.com/debaggi/debaggi-cases/tree/main/HouseGet)<br>

▶ Исследовательский кейс: анализ демографических данных<br>
